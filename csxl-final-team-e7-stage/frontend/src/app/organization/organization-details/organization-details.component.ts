...
export class OrganizationDetailsComponent {
  ...
  public organizationMembers!: Observable<PublicProfile[]>;
  public isLeader$: Observable<boolean> = of(false);
  public organizationMember: Observable<OrganizationMember | null> = of(null);
  ...
  constructor(
    ...
    if (this.profile) {
      ...
      this.organizationMember = this.organizationService.getOrganizationMember(
        this.organization.slug
      );
      this.organizationMembers =
        this.organizationService.getOrganizationMembers(data.organization.slug);
    }
  }
}
