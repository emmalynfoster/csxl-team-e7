...
class UserEntity(EntityBase):
    ...
    # The organizations for the given user.
    # NOTE: These fields establish a many-to-many relationship between the permission and users table.
    memberships: Mapped[list["OrganizationMemberEntity"]] = relationship(
